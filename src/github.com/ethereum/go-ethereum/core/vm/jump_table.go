...
type operation struct {
	...
	halts   bool // indicates whether the operation should halt further execution	表示操作是否停止进一步执行
...
//拜占庭版本首先调用NewHomesteadInstructionSet创造了前一个版本的指令,然后增加自己特有的指令.STATICCALL ,RETURNDATASIZE ,RETURNDATACOPY ,REVERT
