...
func New(ctx *node.ServiceContext, config *Config) (*Ethereum, error) {
	...
	eth := &Ethereum{
		...
		etherbase:      config.Etherbase,	//挖矿的受益者(地址)
	...
	// bloomIndexer 暂时不知道是什么东西 这里面涉及得也不是很多
...
/**
服务的Protocols方法会返回服务提供了那些p2p的Protocol。 返回协议管理器里面的所有SubProtocols.
如果有lesServer那么还提供lesServer的Protocol。
可以看到。所有的网络功能都是通过Protocol的方式提供出来的
 */
